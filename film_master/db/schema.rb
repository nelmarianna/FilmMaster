...
ActiveRecord::Schema.define(version: 20160331145643) do
  ...
  add_index "actors", ["actor_id"], name: "index_actors_on_actor_id", unique: true, using: :btree
  ...
  add_index "genres", ["genre_id"], name: "index_genres_on_genre_id", unique: true, using: :btree
  ...
  add_index "profiles", ["profile_id"], name: "index_profiles_on_profile_id", unique: true, using: :btree
  ...
  add_index "studios", ["studio_id"], name: "index_studios_on_studio_id", unique: true, using: :btree
